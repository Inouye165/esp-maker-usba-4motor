...
def build_parser() -> argparse.ArgumentParser:
    ...
    linear_parser.add_argument("--enable-balancing", action="store_true", help="Enable improved wheel-balancing controls and sync trim")
    linear_parser.add_argument("--enable-braking", "--braking", action="store_true", help="Enable shared low-speed dynamic braking pulse")
